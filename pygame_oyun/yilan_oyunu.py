...
class SNAKE:
    ...
    def move(self):
        ...
        if new[0] in range(0,screen_width) and new[1] in range(0,screen_height) and not new in self.positions[2:0]:
...
def main():
    ...
    while True:
        ...
        # screen.fill((255,0,0))#arka plan
        # rect=pygame.Rect(100,100,200,200) #x,y,genislik,yukseklik
